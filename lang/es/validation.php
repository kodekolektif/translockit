...
return [
    ...
    |--------------------------------------------------------------------------
    |
     | Estos mensajes de error se utilizan por la clase de validación. Algunos
     | de estas reglas tienen múltiples versiones como las reglas de tamaño.
     | Siéntete libre de editar cada uno para adaptarlo a tu aplicación.
     |
    */
    ...
    'password'             => [
        ...
        'uncompromised' => 'El :attribute indicado ha aparecido en una filtración de datos. Por favor elige uno diferente.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
     | Aquí puedes especificar mensajes de validación personalizados por
     | atributo y regla, usando la convención "attribute.rule".
     |
    */
    ...
    |--------------------------------------------------------------------------
    |
     | Estos atributos se usan para reemplazar el placeholder :attribute con
     | nombres más amigables (p.ej. "Correo Electrónico" en lugar de "email").
     |
    */

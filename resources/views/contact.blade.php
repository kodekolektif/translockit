        ...
        <div class="row">
            <div class="col-xxl-5 col-xl-6 col-lg-6">
                <div class="section-title-wrapper mb-15">
                    <h5 class="section-subtitle mb-20" style="overflow: hidden; white-space: nowrap;">{{
                        __('landing.contact.keep_in_touch') }}</h5>
                ...
                <div class="contact-info mr-50 mr-xs-0  mr-md-0" style="margin-bottom: 30px !important">
                    ...
                    <div class="single-contact-info d-flex align-items-center">
                        ...
                        <div class="contact-info-text mt-10">
                            ...
                            <h5><a href="tell:{{ $phone }}">{{ $phone }}</a></h5>
                        </div>
                    </div>
                    @endif
                    @if ($email)
                    ...
                    <form action="{{ route('contact.send') }}" id="contact-form" method="POST">
                        ...
                        <div class="row">
                            <div class="col-xxl-6 col-xl-6 col-lg-6 mb-20">
                                <input name="name" type="text" placeholder="{{ __('landing.contact.your_name') }}"
                                    required>
                            </div>
                            <div class="col-xxl-6 col-xl-6 col-lg-6 mb-20">
                                <input name="email" type="email" placeholder="{{ __('landing.contact.email_address') }}"
                                    required>
                            </div>
                            <div class="col-xxl-6 col-xl-6 col-lg-6 mb-20">
                                <input name="phone" type="text" placeholder="{{ __('landing.contact.phone_number') }}"
                                    required>
                            </div>
                            <div class="col-xxl-6 col-xl-6 col-lg-6 mb-20">
                                <input name="subject" type="text" placeholder="{{ __('landing.contact.subject') }}"
                                    required>
                            </div>
                            <div class="col-xxl-12 col-xl-12 col-lg-12 mb-20">
                                <textarea placeholder="{{ __('landing.contact.write_message') }}" name="message"
                                    required></textarea>
                            </div>

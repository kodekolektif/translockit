                            ...
                            <div class="col-6">
                                <div class="abs-items mb-20">
                                    ...
                                    <div class="abs-item-text fix">
                                        <h3 class="abs-item-title">{{ __('landing.Customized mobile applications.') }}</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="abs-items mb-20">
                                    ...
                                    <div class="abs-item-text fix">
                                        <h3 class="abs-item-title">{{ __('landing.Artificial Intelligence (AI).') }}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="abs-img img-filter mb-30">
                               <img src="{{ asset('assets/img/about/About-TranslockIt_1.jpg') }}" alt="" style="width: 600px; height: 340px;">
                            </div>
                        </div>
                        <div class="col-5">
